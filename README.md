...
- **Draw/Resign**: Buttons in the WebUI can be used to Draw or Resign or Lift both kings off the board and hold them lifted for 2 seconds to end the game in a Draw.
